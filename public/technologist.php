...
$siteDetails['title']='Technologist Staff';

//Response to a GET request for a single technologist staff
if (isset($_GET['id']) || !empty($_GET['id'])) {
    $person = \DeptTemplate\Model\People::getSingleStaff('technologist.json', $_GET['id']);
...
// Fetch data
$people = \DeptTemplate\Model\People::getPeople('technologist.json');
