...
$siteDetails['title']='Academic Staff';

//Response to a GET request for a single academic staff
if (isset($_GET['id']) || !empty($_GET['id'])) {
    $person = \DeptTemplate\Model\People::getSingleStaff('academic.json', $_GET['id']);
...
// Fetch data
$people = \DeptTemplate\Model\People::getPeople('academic.json');
